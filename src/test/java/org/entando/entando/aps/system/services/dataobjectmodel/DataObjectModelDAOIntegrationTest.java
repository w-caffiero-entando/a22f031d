...
public class DataObjectModelDAOIntegrationTest extends BaseTestCase {
    ...
    public void testAddUpdateContentModel() throws Throwable {
        ...
        Map<Long, DataObjectModel> models = this.dataModelDAO.loadDataModels();
        int initSize = models.size();
        try {
            this.dataModelDAO.addDataModel(contentModel);
            models = this.dataModelDAO.loadDataModels();
            ...
            this.dataModelDAO.deleteDataModel(contentModel);
            models = this.dataModelDAO.loadDataModels();
    ...
    private void updateContentModel(DataObjectModel modelToUpdate) throws Throwable {
        ...
        try {
            this.dataModelDAO.updateDataModel(modelToUpdate);
            Map<Long, DataObjectModel> models = this.dataModelDAO.loadDataModels();
            DataObjectModel extracted = models.get(new Long(99));
            assertNotNull(extracted);
    ...
    private void init() throws Exception {
        try {
            ...
            dataModelDAO = new DataObjectModelDAO();
            ((DataObjectModelDAO) dataModelDAO).setDataSource(dataSource);
        } catch (Throwable e) {

...
public interface SystemConstants {
    ...
    public static final List<String> API_RESERVED_PARAMETERS = Collections.unmodifiableList(
            Arrays.asList(API_LANG_CODE_PARAMETER, API_USER_PARAMETER, API_OAUTH_CONSUMER_PARAMETER,

...
[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=entando_repository-scan-test&metric=alert_status)](https://sonarcloud.io/dashboard?id=entando_repository-scan-test)
[![Coverage](https://sonarcloud.io/api/project_badges/measure?project=entando_repository-scan-test&metric=coverage)](https://entando.github.io/devops-results/entando-engine/master/jacoco/index.html)
[![Vulnerabilities](https://sonarcloud.io/api/project_badges/measure?project=entando_repository-scan-test&metric=vulnerabilities)](https://entando.github.io/devops-results/entando-engine/master/dependency-check-report.html)
[![Code Smells](https://sonarcloud.io/api/project_badges/measure?project=entando_repository-scan-test&metric=code_smells)](https://sonarcloud.io/dashboard?id=entando_repository-scan-test)
[![Security Rating](https://sonarcloud.io/api/project_badges/measure?project=entando_repository-scan-test&metric=security_rating)](https://sonarcloud.io/dashboard?id=entando_repository-scan-test)
[![Technical Debt](https://sonarcloud.io/api/project_badges/measure?project=entando_repository-scan-test&metric=sqale_index)](https://sonarcloud.io/dashboard?id=entando_repository-scan-test)
